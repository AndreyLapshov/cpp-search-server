...
public:
    ...
    template <typename StringContainer>
        inline explicit SearchServer(const StringContainer& stop_words)
   ...
   template <typename DocumentPredicate>
    ...
    template <typename DocumentPredicate>
    vector<Document> inline FindAllDocuments(const Query& query, DocumentPredicate document_predicate) const {
